...
const about = (() => {
  ...
  `Founded in 1902, Restaurant was the creation of Jimmy's brilliant idea. Ever since it's inception, Restaurant has served millions of customers with only the finest pizzas man has ever created. 
